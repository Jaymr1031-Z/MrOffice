...
MrOffice opens, edits, and saves documents locally. Document editing does not
upload files to MrOffice. AI features require a network connection and send
...
app does not send a city or region. Neither identifier is an account or email
address.
...
security or spam-abuse processing. MrOffice does not add an IP address to the
event payload.

## Data not collected by analytics

MrOffice analytics never sends:
