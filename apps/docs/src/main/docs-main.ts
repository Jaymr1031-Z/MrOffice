...
const tMain = createI18n({
 ...
 menuDocsHelp: 'MrOffice Docs Help',
 },
 ja: {
 dlgOpenDoc: '文書を開く',
 filterWord: 'Word 文書',
 ...
 menuDocsHelp: 'MrOffice Docs ヘルプ',
 },
 ko: {
 dlgOpenDoc: '문서 열기',
 filterWord: 'Word 문서',
 ...
 menuDocsHelp: 'MrOffice Docs 도움말',
 },
 fr: {
 ...
 menuDocsHelp: 'Aide MrOffice Docs',
 },
 de: {
 ...
 menuDocsHelp: 'MrOffice Docs-Hilfe',
 },
 es: {
 ...
 menuDocsHelp: 'Ayuda de MrOffice Docs',
 },
 th: {
 ...
 menuDocsHelp: 'วิธีใช้ MrOffice Docs',
 },
 id: {
 ...
 menuDocsHelp: 'Bantuan MrOffice Docs',
 },
 ru: {
 ...
 menuDocsHelp: 'Справка MrOffice Docs',
 },
 ar: {
 ...
 menuDocsHelp: 'تعليمات MrOffice Docs',
 },
 pt: {
 dlgOpenDoc: 'Abrir Documento',
 ...
 menuDocsHelp: 'Ajuda do MrOffice Docs',
 },
 it: {
 ...
 menuDocsHelp: 'Guida di MrOffice Docs',
 },
 pl: {
 ...
 menuDocsHelp: 'Pomoc MrOffice Docs',
 },
 nl: {
 ...
 menuDocsHelp: 'עזרה של MrOffice Docs',
 },
 hi: {
 ...
 menuDocsHelp: 'MrOffice Docs सहायता',
 },
 'zh-TW': {
 dlgOpenDoc: '開啟文件',
 filterWord: 'Word 文件',
...
/** default folder where new files land on their first (silent) save; shared with the other editors via shell. User-configurable (app-settings.json), falls back to <Documents>/MrOffice. */
...
export function registerAiIpc(): void {
 ...
 // a stored provider is honored when usable; half-filled configs fall back to Codex
...
export function registerDocsIpc(): void {
 ...
 setAiUserAgent(`MrOffice/${app.getVersion()}`)
...
interface DocsShellHooks {
 ...
 closeActiveTab(): void
 /** Shell router used to open exported PDFs in a new MrOffice tab. */
...
export function startDocsStandalone(): void {
 ...
 // the installed MrOffice Docs is open and forwards its argv there instead.
 ...
 else if (isDev) app.setPath('userData', join(app.getPath('appData'), 'MrOffice Docs Dev'))
