...
import type { Block } from '@mroffice/docx-engine'
import { AgentLoop, composeSkills, type AgentImage } from '@mroffice/agent-core'
...
/** File-type icons for attachment cards (AI attachment icon set); exts the
