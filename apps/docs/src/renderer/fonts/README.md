...
to the same faces) and are referenced here as `@mroffice/ui/fonts/Carlito-*.ttf`.
...
The serif subset also backs the `MrOffice Fullwidth TC` face (`fonts.css`), a
...
| Font                                 | Role                                                        |
| ------------------------------------ | ----------------------------------------------------------- |
| MrOffice Serif KR (subset woff2)    | Batang-metric stand-in for Korean serif families            |
| MrOffice Sans KR (subset woff2)     | fallback for Korean sans families (Malgun etc.)             |
| MrOffice Che Latin KR (ASCII woff2) | half-width Latin for BatangChe/GulimChe/DotumChe/GungsuhChe |
...
`MrOfficeCheLatinKR.woff2` is an ASCII-only derivative of MrOffice Sans KR.
...
| Font                               | Role                                            |
| ---------------------------------- | ----------------------------------------------- |
| MrOffice Gothic KR (subset woff2) | real-metric face for NanumGothic-declaring docs |
...
`MrOfficeGothicKR-Regular-subset.woff2`. Renamed per OFL (the upstream
...
| Font                                      | Role                                                |
| ----------------------------------------- | --------------------------------------------------- |
| MrOffice UI Kana JP (Regular/Bold woff2) | Meiryo UI-advance kana/JP punctuation for the alias |
...
| Font                             | Role                                 |
| -------------------------------- | ------------------------------------ |
| MrOffice Poppins (subset woff2) | real face for Poppins-declaring docs |
...
checked in as `MrOfficePoppins-{Regular,Bold}-subset.woff2`. Renamed (no
...
| Font                    | Role                                     |
| ----------------------- | ---------------------------------------- |
| MrOffice Tamil (woff2) | Latha-metric stand-in for Tamil families |
...
| Font                              | Role                                             |
| --------------------------------- | ------------------------------------------------ |
| MrOffice PUA Blank (woff2, 312B) | blank 1em glyph for all of U+E000-F8FF (BMP PUA) |
