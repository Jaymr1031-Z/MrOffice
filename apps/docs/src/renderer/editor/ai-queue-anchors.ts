 ...
 * dirty untouched paragraphs or leak anything into the docx. An anchor whose
 * text is deleted collapses and drops out of the set — the queue reads that
 * back as "target gone".
 */
...
export const AI_QUEUE_ANCHOR_CLICK = 'docs-ai-queue-anchor-click'

export const AiQueueAnchorsExtension = Extension.create({
 name: 'aiQueueAnchors',
