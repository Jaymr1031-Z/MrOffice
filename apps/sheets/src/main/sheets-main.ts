...
interface SheetsRuntimeConfig {
 ...
 /** Shell router used to open exported/AI-generated files in a new MrOffice tab. */
...
async function createStandaloneSheetsDocument(
 ...
 return { ok: false, error: 'Creating DOCX files requires the MrOffice shell or Docs app.' }
 }
