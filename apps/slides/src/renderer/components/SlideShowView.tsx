...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@mroffice/pptx-render'
...
function ShowMediaLayer({
 ...
 (n): n is import('@mroffice/pptx-render').PictureRenderNode =>
 n.type === 'picture' && !!(n as import('@mroffice/pptx-render').PictureRenderNode).media,
 )
