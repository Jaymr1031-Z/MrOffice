 ...
 * is shared across apps via @mroffice/ui (re-exported here for existing
 * imports); SmartArt thumbs reuse the engine's layout math so preview and
 * insert result always match.
 */
import { shapePreviewPath } from '@mroffice/ui'
import {
 layoutShapes,
 type SmartArtLayout,
} from '../../../../../packages/pptx-engine/src/smartart-layout'

export { ShapePreview, shapePreviewBox, shapePreviewPath } from '@mroffice/ui'
