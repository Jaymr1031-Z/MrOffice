...
import { showOpenDialogWithMemory } from '@mroffice/electron-utils'
...
/** office/pdf formats extract text via @mroffice/file-parse; images skip text extraction and go multimodal (slides:files-read-image) */
...
/** Extract attachment text via @mroffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
