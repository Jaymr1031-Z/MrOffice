 ...
 * the local gen_pptx capture emits): absolutely positioned shapes, images
...
import { buildRenderSlide, EMU_PER_PX_96, type FontMetricsProvider } from '@mroffice/pptx-render'
