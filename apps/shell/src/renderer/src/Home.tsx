...
import logoBadge from './assets/mrlogo.png'
...
import { useDismissablePopover } from '@mroffice/ui'
...
function SettingsEntry() {
 ...
 <path
 d="M6.7 1.8h2.6l.4 1.7a4.8 4.8 0 0 1 1.1.6l1.6-.7 1.8 1.8-.7 1.6c.2.4.4.8.5 1.2l1.7.4V11l-1.7.4a4.8 4.8 0 0 1-.5 1.1l.7 1.6-1.8 1.8-1.6-.7a4.8 4.8 0 0 1-1.1.5l-.4 1.7H6.7l-.4-1.7a4.8 4.8 0 0 1-1.1-.5l-1.6.7-1.8-1.8.7-1.6a4.8 4.8 0 0 1-.5-1.1L.3 11V8.4L2 8a4.8 4.8 0 0 1 .5-1.2l-.7-1.6 1.8-1.8 1.6.7a4.8 4.8 0 0 1 1.1-.6l.4-1.7Z"
 stroke="currentColor"
 strokeWidth="1.1"
 strokeLinejoin="round"
 />
 <circle cx="8" cy="9.7" r="2.1" stroke="currentColor" strokeWidth="1.1" />
 </svg>
 </span>
...
export function Home() {
 ...
 {key === 'recent' ? t('navRecent') : t('navOldest')}
 </button>
 ))}
 </div>
 )}
 ...
 <img className="logo-badge" src={logoBadge} alt="" />
          <span className="logo-wordmark">MrOffice</span>
 </div>
