...
export const strings = {
 ...
 setAiByokNote: 'AI requests use your configured provider and API key.',
 setAiSave: '保存',
 setAiSaved: '已保存',
 setAiTest: '测试连接',
 setAiTesting: '测试中…',
 ...
 starPromptTitle: '喜欢 MrOffice 吗？',
 starPromptTitleN: '你已经用 MrOffice 打开了 {n} 个文档',
 starPromptBody: 'MrOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
 starPromptGo: '去点 Star',
 starPromptDone: '已经点过了',
 starPromptLater: '以后再说',
 onbStarHint: '如果你喜欢 MrOffice，欢迎到 GitHub 给我们一个 Star。',
 setChange: '更改',
 // Dates
 today: '今天',
 yesterday: '昨天',
 ...
 onbTitle1: '欢迎使用 MrOffice',
 onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
 onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
 onbTitle2: '这只是一个开始',
 onbBody2: 'MrOffice 目前处于 alpha 阶段。欢迎加入 MrOffice 群聊，分享反馈，一起塑造它的未来。',
 onbSkip: '跳过',
 onbNext: '下一步',
 onbStart: '开始使用',
 ...
 starPromptTitle: 'Enjoying MrOffice?',
 starPromptTitleN: "You've opened {n} documents with MrOffice",
 starPromptBody:
 'MrOffice is free and open source. A star on GitHub is the best way to support the team.',
 starPromptGo: 'Star on GitHub',
 starPromptDone: 'Already starred',
 starPromptLater: 'Maybe later',
 onbStarHint: 'If you like MrOffice, give us a star on GitHub.',
 setChange: 'Change',
 today: 'Today',
 yesterday: 'Yesterday',
 daysAgo: '{n}d ago',
 ...
 onbBody2:
 'MrOffice is still in alpha. Join the group chat on MrOffice to share feedback and help shape what comes next.',
 onbSkip: 'Skip',
 onbNext: 'Next',
 ...
 starPromptTitle: 'MrOffice はいかがですか？',
 starPromptTitleN: 'MrOffice で {n} 件のドキュメントを開きました',
 starPromptBody:
 'MrOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
 starPromptGo: 'スターを付ける',
 starPromptDone: 'スター済み',
 starPromptLater: 'あとで',
 onbStarHint: 'MrOffice が気に入ったら、GitHub でスターをお願いします。',
 setChange: '変更',
 // Dates
 today: '今日',
 yesterday: '昨日',
 ...
 starPromptTitle: 'MrOffice가 마음에 드시나요?',
 starPromptTitleN: 'MrOffice로 문서를 {n}개 열어보셨네요',
 starPromptBody:
 'MrOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
 starPromptGo: '스타 누르기',
 starPromptDone: '이미 눌렀어요',
 starPromptLater: '나중에',
 onbStarHint: 'MrOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
 setChange: '변경',
 // Dates
 today: '오늘',
 yesterday: '어제',
 ...
 starPromptTitle: 'MrOffice vous plaît ?',
 starPromptTitleN: 'Vous avez ouvert {n} documents avec MrOffice',
 starPromptBody:
 'MrOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
 starPromptGo: 'Mettre une étoile',
 starPromptDone: 'Déjà fait',
 starPromptLater: 'Plus tard',
 onbStarHint: 'Si MrOffice vous plaît, mettez-nous une étoile sur GitHub.',
 setChange: 'Modifier',
 // Dates
 today: "Aujourd'hui",
 yesterday: 'Hier',
 ...
 // First-run onboarding
 onbTitle1: 'Bienvenue dans MrOffice',
 ...
 onbBody2:
 'MrOffice est encore en alpha. Rejoignez la discussion de groupe sur MrOffice pour partager vos retours et façonner la suite.',
 onbSkip: 'Passer',
 onbNext: 'Suivant',
 onbStart: 'Commencer',
 ...
 starPromptTitle: 'Gefällt Ihnen MrOffice?',
 starPromptTitleN: 'Sie haben {n} Dokumente mit MrOffice geöffnet',
 starPromptBody:
 'MrOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
 starPromptGo: 'Stern geben',
 starPromptDone: 'Schon erledigt',
 starPromptLater: 'Später',
 onbStarHint: 'Wenn Ihnen MrOffice gefällt, geben Sie uns einen Stern auf GitHub.',
 setChange: 'Ändern',
 // Dates
 today: 'Heute',
 yesterday: 'Gestern',
 ...
 newTab: 'Neuer Tab',
 // First-run onboarding
 onbTitle1: 'Willkommen bei MrOffice',
 ...
 onbBody2:
 'MrOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf MrOffice bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
 ...
 starPromptTitle: '¿Te gusta MrOffice?',
 starPromptTitleN: 'Has abierto {n} documentos con MrOffice',
 starPromptBody:
 'MrOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
 starPromptGo: 'Dar una estrella',
 starPromptDone: 'Ya la di',
 starPromptLater: 'Más tarde',
 onbStarHint: 'Si te gusta MrOffice, danos una estrella en GitHub.',
 setChange: 'Cambiar',
 // Dates
 today: 'Hoy',
 yesterday: 'Ayer',
 ...
 // First-run onboarding
 onbTitle1: 'Bienvenido a MrOffice',
 ...
 onbBody2:
 'MrOffice aún está en alfa. Únete al chat grupal en MrOffice para compartir comentarios y ayudar a dar forma a lo que viene.',
 onbSkip: 'Omitir',
 onbNext: 'Siguiente',
 onbStart: 'Empezar',
 ...
 starPromptTitle: 'ชอบ MrOffice ไหม?',
 starPromptTitleN: 'คุณเปิดเอกสารด้วย MrOffice ไปแล้ว {n} ไฟล์',
 starPromptBody:
 'MrOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
 starPromptGo: 'กดดาวเลย',
 starPromptDone: 'กดแล้ว',
 starPromptLater: 'ไว้ทีหลัง',
 onbStarHint: 'ถ้าชอบ MrOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
 setChange: 'เปลี่ยน',
 // Dates
 today: 'วันนี้',
 yesterday: 'เมื่อวาน',
 ...
 newTab: 'แท็บใหม่',
 // First-run onboarding
 onbTitle1: 'ยินดีต้อนรับสู่ MrOffice',
 ...
 onbBody2:
 'MrOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน MrOffice เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
 onbSkip: 'ข้าม',
 onbNext: 'ถัดไป',
 ...
 starPromptTitle: 'Suka MrOffice?',
 starPromptTitleN: 'Anda telah membuka {n} dokumen dengan MrOffice',
 starPromptBody:
 'MrOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
 starPromptGo: 'Beri Bintang',
 starPromptDone: 'Sudah',
 starPromptLater: 'Nanti saja',
 onbStarHint: 'Jika Anda menyukai MrOffice, beri kami bintang di GitHub.',
 setChange: 'Ubah',
 // Dates
 today: 'Hari ini',
 yesterday: 'Kemarin',
 ...
 newTab: 'Tab baru',
 // First-run onboarding
 onbTitle1: 'Selamat datang di MrOffice',
 ...
 onbBody2:
 'MrOffice masih dalam tahap alpha. Gabung obrolan grup di MrOffice untuk berbagi masukan dan ikut menentukan arah ke depan.',
 onbSkip: 'Lewati',
 onbNext: 'Berikutnya',
 onbStart: 'Mulai',
 ...
 starPromptTitle: 'Нравится MrOffice?',
 starPromptTitleN: 'Вы уже открыли {n} документов в MrOffice',
 starPromptBody:
 'MrOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
 starPromptGo: 'Поставить звезду',
 starPromptDone: 'Уже поставлена',
 starPromptLater: 'Позже',
 onbStarHint: 'Если вам нравится MrOffice, поставьте нам звезду на GitHub.',
 setChange: 'Изменить',
 // Dates
 today: 'Сегодня',
 yesterday: 'Вчера',
 ...
 // First-run onboarding
 onbTitle1: 'Добро пожаловать в MrOffice',
 ...
 onbBody2:
 'MrOffice пока в альфа-версии. Присоединяйтесь к групповому чату в MrOffice, чтобы делиться отзывами и влиять на дальнейшее развитие.',
 onbSkip: 'Пропустить',
 onbNext: 'Далее',
 onbStart: 'Начать',
 ...
 starPromptTitle: 'هل أعجبك MrOffice؟',
 starPromptTitleN: 'لقد فتحت {n} من المستندات في MrOffice',
 starPromptBody: 'MrOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
 starPromptGo: 'ضع نجمة',
 starPromptDone: 'وضعتها بالفعل',
 starPromptLater: 'لاحقًا',
 onbStarHint: 'إذا أعجبك MrOffice، ضع لنا نجمة على GitHub.',
 setChange: 'تغيير',
 // Dates
 today: 'اليوم',
 yesterday: 'أمس',
 ...
 // First-run onboarding
 onbTitle1: 'مرحبًا بك في MrOffice',
 ...
 onbBody2:
 'لا يزال MrOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على MrOffice لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
 onbSkip: 'تخطي',
 onbNext: 'التالي',
 onbStart: 'ابدأ الآن',
 ...
 starPromptTitle: 'Gostando do MrOffice?',
 starPromptTitleN: 'Você já abriu {n} documentos com o MrOffice',
 starPromptBody:
 'O MrOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
 starPromptGo: 'Dar uma estrela',
 starPromptDone: 'Já dei',
 starPromptLater: 'Mais tarde',
 onbStarHint: 'Se você gosta do MrOffice, deixe uma estrela no GitHub.',
 setChange: 'Alterar',
 today: 'Hoje',
 yesterday: 'Ontem',
 daysAgo: 'há {n} dias',
 ...
 newTab: 'Nova guia',
 // First-run onboarding
 onbTitle1: 'Bem-vindo ao MrOffice',
 ...
 onbBody2:
 'O MrOffice ainda está em alfa. Entre no chat em grupo no MrOffice para compartilhar feedback e ajudar a moldar o que vem a seguir.',
 onbSkip: 'Pular',
 onbNext: 'Avançar',
 onbStart: 'Começar',
 onbStepAria: 'Página {n} de {total}',
 ...
 starPromptTitle: 'Ti piace MrOffice?',
 starPromptTitleN: 'Hai aperto {n} documenti con MrOffice',
 starPromptBody:
 'MrOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
 starPromptGo: 'Metti una stella',
 starPromptDone: 'Già fatto',
 starPromptLater: 'Più tardi',
 onbStarHint: 'Se ti piace MrOffice, lasciaci una stella su GitHub.',
 setChange: 'Cambia',
 today: 'Oggi',
 yesterday: 'Ieri',
 daysAgo: '{n} giorni fa',
 ...
 newTab: 'Nuova scheda',
 // First-run onboarding
 onbTitle1: 'Benvenuto in MrOffice',
 ...
 onbBody2:
 'MrOffice è ancora in alpha. Unisciti alla chat di gruppo su MrOffice per condividere feedback e contribuire a plasmare il futuro.',
 onbSkip: 'Salta',
 onbNext: 'Avanti',
 onbStart: 'Inizia',
 ...
 starPromptTitle: 'Podoba Ci się MrOffice?',
 starPromptTitleN: 'Otwarto już {n} dokumentów w MrOffice',
 starPromptBody:
 'MrOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
 starPromptGo: 'Daj gwiazdkę',
 starPromptDone: 'Już zrobione',
 starPromptLater: 'Później',
 onbStarHint: 'Jeśli podoba Ci się MrOffice, zostaw nam gwiazdkę na GitHubie.',
 setChange: 'Zmień',
 today: 'Dzisiaj',
 yesterday: 'Wczoraj',
 daysAgo: '{n} dni temu',
 ...
 onbBody2:
 'MrOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na MrOffice, aby dzielić się opiniami i współtworzyć jego przyszłość.',
 onbSkip: 'Pomiń',
 onbNext: 'Dalej',
 onbStart: 'Rozpocznij',
 ...
 starPromptTitle: 'Bevalt MrOffice?',
 starPromptTitleN: 'Je hebt al {n} documenten geopend met MrOffice',
 starPromptBody:
 'MrOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
 starPromptGo: 'Geef een ster',
 starPromptDone: 'Al gedaan',
 starPromptLater: 'Later',
 onbStarHint: 'Als MrOffice je bevalt, geef ons dan een ster op GitHub.',
 setChange: 'Wijzigen',
 today: 'Vandaag',
 yesterday: 'Gisteren',
 ...
 onbBody2:
 'MrOffice is nog in alfa. Doe mee aan de groepschat op MrOffice om feedback te delen en mee te bepalen wat er komt.',
 onbSkip: 'Overslaan',
 onbNext: 'Volgende',
 ...
 starPromptTitleN: 'Anda telah membuka {n} dokumen dengan MrOffice',
 starPromptBody:
 'MrOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
 starPromptGo: 'Beri Bintang',
 starPromptDone: 'Sudah',
 starPromptLater: 'Kemudian',
 onbStarHint: 'Jika anda suka MrOffice, beri kami bintang di GitHub.',
 setChange: 'Tukar',
 today: 'Hari ini',
 yesterday: 'Semalam',
 daysAgo: '{n} hari lalu',
 ...
 newTab: 'Tab baharu',
 // First-run onboarding
 onbTitle1: 'Selamat datang ke MrOffice',
 ...
 onbTitle2: 'Ini baru permulaan',
 onbBody2:
 'MrOffice masih dalam peringkat alfa. Sertai sembang kumpulan di MrOffice untuk berkongsi maklum balas dan membentuk masa depannya.',
 onbSkip: 'Langkau',
 onbNext: 'Seterusnya',
 onbStart: 'Mula',
 ...
 starPromptTitle: 'נהנים מ-MrOffice?',
 starPromptTitleN: 'פתחת {n} מסמכים עם MrOffice',
 starPromptBody: 'MrOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
 starPromptGo: 'לתת כוכב',
 starPromptDone: 'כבר נתתי',
 starPromptLater: 'אחר כך',
 onbStarHint: 'אם MrOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
 setChange: 'שינוי',
 today: 'היום',
 yesterday: 'אתמול',
 daysAgo: 'לפני {n} ימים',
 ...
 // First-run onboarding
 onbTitle1: 'ברוכים הבאים ל-MrOffice',
 ...
 onbBody2:
 'MrOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-MrOffice כדי לשתף משוב ולעזור לעצב את ההמשך.',
 onbSkip: 'דילוג',
 onbNext: 'הבא',
 onbStart: 'להתחיל',
 ...
 starPromptTitle: 'MrOffice पसंद आ रहा है?',
 starPromptTitleN: 'आपने MrOffice में {n} दस्तावेज़ खोले हैं',
 starPromptBody:
 'MrOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
 starPromptGo: 'स्टार दें',
 starPromptDone: 'पहले ही दे दिया',
 starPromptLater: 'बाद में',
 onbStarHint: 'अगर आपको MrOffice पसंद है, तो हमें GitHub पर स्टार दें।',
 setChange: 'बदलें',
 today: 'आज',
 yesterday: 'कल',
 daysAgo: '{n} दिन पहले',
 ...
 newTab: 'नया टैब',
 // First-run onboarding
 onbTitle1: 'MrOffice में आपका स्वागत है',
 ...
 onbBody2:
 'MrOffice अभी अल्फ़ा में है। MrOffice पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
 onbSkip: 'छोड़ें',
 onbNext: 'आगे',
 onbStart: 'शुरू करें',
 ...
 starPromptTitle: '喜歡 MrOffice 嗎？',
 starPromptTitleN: '你已經用 MrOffice 開啟了 {n} 個文件',
 starPromptBody: 'MrOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
 starPromptGo: '去給星星',
 starPromptDone: '已經給過了',
 starPromptLater: '以後再說',
 onbStarHint: '如果你喜歡 MrOffice，歡迎到 GitHub 給我們一顆星。',
 setChange: '變更',
 today: '今天',
 yesterday: '昨天',
 daysAgo: '{n} 天前',
 ...
 newTab: '新分頁',
 // First-run onboarding
 onbTitle1: '歡迎使用 MrOffice',
 onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
 onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
 onbTitle2: '這只是一個開始',
 onbBody2: 'MrOffice 目前仍在 alpha 階段。歡迎加入 MrOffice 群聊，分享回饋，一起打造它的未來。',
 onbSkip: '略過',
 onbNext: '下一步',
 onbStart: '開始使用',
