...
export interface HomeApi {
 ...
 /** effective default save folder for new/untitled files (configured in userData/app-settings.json, falls back to <Documents>/MrOffice) */
 ...
 /** open the MrOffice community page in the default browser */
