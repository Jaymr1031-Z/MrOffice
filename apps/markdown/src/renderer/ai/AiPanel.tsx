...
import { AgentLoop, composeSkills } from '@mroffice/agent-core'
import type { AiSettings } from '@mroffice/ai-provider'
import { AiComposer, AiTypingIndicator, Markdown } from '@mroffice/ui'
...
/** Generic AI sparkle mark, inline for crisp device-resolution rendering.
 * Neutral, brand-agnostic glyph used wherever an AI affordance is shown. */
export function AiMark({ size = 24 }: { size?: number }) {
 return (
 <svg
 width={size}
 height={size}
 ...
 >
 <path
 d="M12 3.5c.4 4.1 3.4 7.1 7.5 7.5-4.1.4-7.1 3.4-7.5 7.5-.4-4.1-3.4-7.1-7.5-7.5 4.1-.4 7.1-3.4 7.5-7.5Z"
 fill="currentColor"
 />
 </svg>
 )
