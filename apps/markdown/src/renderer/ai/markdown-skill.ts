...
const AGENT_SYSTEM_PROMPT = [
 'You are the writing assistant inside MrOffice Markdown, a markdown document editor.',
 ...
 '',
 '## Images',
 '- To add a picture, use image_search, pick the best fit, then insert_image.',
