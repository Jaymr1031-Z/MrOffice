...
export default defineConfig({
 // @mroffice/i18n ships as TS source; pdf-lib's package only includes out/** — both must be bundled
 main: {
 plugins: [
 ...
 plugins: [externalizeDepsPlugin({ exclude: ['@mroffice/i18n', '@mroffice/electron-utils'] })],
 },
 renderer: {
 plugins: [
 react(),
