...
const STATIC_FORM_FILLS_KEY = PDFName.of('MrOfficeStaticFormFills')
...
function setVisualSignatureMetadata(annot: PDFDict, fieldName: string | undefined): void {
 if (!fieldName) return
 annot.set(PDFName.of('MrOfficeFormField'), PDFHexString.fromText(fieldName))
 annot.set(
 PDFName.of('Contents'),
...
async function addImageStamp(
 ...
 annot.set(PDFName.of('T'), PDFHexString.fromText('MrOffice'))
...
function addDrawing(
 ...
 annot.set(PDFName.of('T'), PDFHexString.fromText(d.author || 'MrOffice'))
