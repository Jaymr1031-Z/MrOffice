import type { Lang } from '@mroffice/i18n'
import type { AiSettings, AiStreamChunk, AiStreamRequest } from '@mroffice/ai-provider'
...
export const VISUAL_SIGNATURE_CONTENT_PREFIX = 'MrOffice visual signature field: '
...
export type DrawingInput =
 ...
 at: [number, number]
 contents: string
 /** Annotation author (/T); omitted → 'MrOffice' */
 author?: string
...
/** Editable metadata for a MrOffice static form fill embedded as a page image. */
...
/** Extract pages into a new PDF written to the MrOffice save dir and opened in a new tab */
 ...
 * MrOffice save dir and opened in a new tab */
...
export interface PdfApi {
 ...
 /** Read MrOffice static-fill metadata stored inside the PDF. */
