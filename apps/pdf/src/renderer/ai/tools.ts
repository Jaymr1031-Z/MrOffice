...
import type { AgentToolCall, AgentToolDef, ToolExecution } from '@mroffice/agent-core'
...
export const AGENT_TOOLS: AgentToolDef[] = [
 ...
 name: 'replace_image',
 description:
 'Swap an existing page image\'s pixels for a downloaded URL from image_search in place — footprint and z-order survive; the new image stretches to the old footprint (takes effect on save). Call list_page_images first; image_number refers to that listing.',
 inputSchema: {
 type: 'object',
 properties: {
 page: { type: 'integer', description: 'Page number (1-based)' },
