...
import { tableRowGridCols } from '@mroffice/pptx-engine/table-grid'
import { elementDurableId, groupChildDurableId } from '@mroffice/pptx-engine/identity'
import { isBackgroundLikeElement } from '@mroffice/pptx-engine/background-promote'
