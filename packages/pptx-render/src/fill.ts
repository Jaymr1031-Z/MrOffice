 ...
 */
import type { Fill, Stroke, ShadowEffect } from '@mroffice/pptx-engine'
...
export function resolveGlow(
  glow: import('@mroffice/pptx-engine').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('@mroffice/pptx-engine').ReflectionEffect | undefined,
  vp: Viewport,
